...
The recorded preflight owns the initial Behavior Map; read the `tdd` skill's Section 1 before writing it. It is authoritative for proof obligations, not architecture selection; a plan may reference it but is not a second proof owner.
