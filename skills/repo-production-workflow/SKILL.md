...
The recorded preflight owns the initial Behavior Map: the proof obligations the `tdd` skill's Section 1 enumerates. It is authoritative for proof obligations, not architecture selection; a plan may reference it but is not a second proof owner.
